    ...
    <section className="space-y-5">
      ...
      <div className="grid gap-4 rounded-xl border border-slate-200 bg-white p-4 md:grid-cols-2">
        <label className="space-y-1 text-sm">
          <span className="font-medium">몬스터</span>
          <select className="w-full rounded-md border border-slate-300 px-3 py-2" value={monsterName} onChange={(e) => setMonsterName(e.target.value)}>
        ...
        <label className="space-y-1 text-sm">
          <span className="font-medium">내 공격력(평균)</span>
          <input
        ...
        <label className="space-y-1 text-sm">
          <span className="font-medium">스킬 계수(%)</span>
          <input
            className="w-full rounded-md border border-slate-300 px-3 py-2"
            type="number"
            min={1}
        ...
        <label className="space-y-1 text-sm">
          <span className="font-medium">목표 타수(n)</span>
          <input
            className="w-full rounded-md border border-slate-300 px-3 py-2"
            type="number"
            min={1}
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-4">
        ...
        <p className="mt-3 text-xs text-slate-600">MVP 추정식입니다. 실제 오차를 줄이려면 직업/숙련도/최소·최대공격력 분산을 추가하세요.</p>
      </div>
    </section>
  );
}
